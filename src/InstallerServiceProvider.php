...
namespace Nzoko\Ninit;

use Illuminate\Support\ServiceProvider;
use Livewire\Livewire;
use Nzoko\Ninit\Contracts\EnvironmentWriter;
use Nzoko\Ninit\Contracts\InstallationStateManager;
use Nzoko\Ninit\Contracts\InstallerStep;
use Nzoko\Ninit\Http\Livewire\Installer;
use Nzoko\Ninit\Services\DotEnvWriter;
use Nzoko\Ninit\Services\FileInstallationStateManager;
use Nzoko\Ninit\Services\StepManager;
...
class InstallerServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                \Nzoko\Ninit\Console\Commands\MakeInstallerStepCommand::class,
            ]);
        }
    }
